...
const getItems = () => {
    ...
    dbqueries.allItemsQuery(function (err, rows) {
        rows.forEach(function (row) {
            item_states.push({ store_id: row.store_id, item_code: row.item_code, category_code: row.category_code, name: row.name, status: row.status, last_updated: row.last_updated })
